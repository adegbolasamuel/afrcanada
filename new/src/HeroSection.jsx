...
import backgroundImage from "./assets/background.png"; // Replace with your actual background image
import madeInAfricaLogo from "./assets/logo.png"; // The small logo above the title
      ...
      <div className="hero-content">
        ...
        <div className="hero-actions">
          <button className="btn btn-primary">
            Register as Exhibitor <span>&rarr;</span>
          </button>
